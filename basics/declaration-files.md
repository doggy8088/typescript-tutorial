...
也可以使用 `declare namespace` 給已有的名稱空間新增型別宣告[24](https://github.com/xcatliu/typescript-tutorial/tree/master/examples/declaration-files/24-merge-global-namespace)：
